...
/*   Updated: 2022/12/26 12:48:42 by dateixei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	stack->i = stack->size_stack_a;
	if (stack->size_stack_b > 0)
	{
		while (stack->i > 0)
		{
			stack->stack_a[stack->i] = stack->stack_a[stack->i - 1];
			stack->i--;
		}
		...
		{
			stack->i = 0;
			while (stack->i < stack->size_stack_b)
			{
				stack->stack_b[stack->i] = stack->stack_b[stack->i + 1];
				stack->i++;
			}
...
void	push_b(t_stacks *stack)
{
	...
	if (stack->size_stack_a > 0)
	{
		...
		{
			stack->i = 0;
			while (stack->i < stack->size_stack_a)
			{
				stack->stack_a[stack->i] = stack->stack_a[stack->i + 1];
				stack->i++;
			}
